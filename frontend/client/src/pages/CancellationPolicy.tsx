      ...
      <div className="container py-16 max-w-4xl">
        ...
        <Card className="p-8 mb-8 bg-primary/5 border-primary/20">
          ...
          <p className="text-muted-foreground mb-4">
            We understand that plans change. Our cancellation policy is designed
            to be fair to both customers and artists while respecting everyone's
            time and commitment.
          </p>
          <p className="text-muted-foreground">
            All bookings require a <strong>$50 deposit</strong> to secure your
            appointment. This deposit is deducted from your final tattoo cost.
          </p>
        </Card>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground mb-3">
                  Cancellations made 48 hours or more before your scheduled
                  appointment receive a <strong>full refund</strong> of the $50
                  deposit.
                </p>
          ...
          <Card className="p-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground mb-3">
                  Cancellations made between 24-48 hours before your appointment
                  receive a <strong>50% refund</strong> of the deposit.
                </p>
                <ul className="list-disc list-inside text-sm text-muted-foreground space-y-1">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground mb-3">
                  ...
                  or no-shows result in{" "}
                  <strong>forfeiture of the full deposit</strong>.
                </p>
                <ul className="list-disc list-inside text-sm text-muted-foreground space-y-1">
        ...
        <div className="mb-12">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  ...
                  <strong>once for free</strong> if done 48+ hours in advance.
                  Contact your artist through your dashboard or their profile
                  page to request a new date and time.
                </p>
              </div>
            </div>
          </Card>
          ...
          <Card className="p-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-lg font-semibold mb-2">
                  Additional Reschedules
                </h3>
                <p className="text-muted-foreground">
                  Additional reschedule requests may incur a $25 rescheduling
                  fee at the artist's discretion. Late reschedules (less than 48
                  hours) follow the same policy as cancellations.
                </p>
              </div>
            </div>
          </Card>
        ...
        <div className="mb-12">
          ...
          <Card className="p-6">
            ...
            <p className="text-muted-foreground mb-4">
              We understand that emergencies happen. In cases of documented
            ...
            <p className="text-muted-foreground">
              Each case is reviewed individually, and we may offer exceptions to
              our standard policy on a case-by-case basis.
            </p>
          </Card>
        </div>
        ...
        <div className="mb-12">
          ...
          <Card className="p-6">
            <p className="text-muted-foreground mb-4">
              If an artist needs to cancel your appointment for any reason, you
              will receive:
            </p>
            <ul className="list-disc list-inside text-muted-foreground space-y-2">
              <li>
                <strong>Full refund</strong> of your deposit
              </li>
              <li>
                <strong>Priority rebooking</strong> with the same artist
              </li>
              <li>
                <strong>$25 credit</strong> toward your next booking if
        ...
        <div className="mb-12">
          ...
          <Card className="p-6">
            <ol className="list-decimal list-inside text-muted-foreground space-y-3">
              <li>
                Log in to your account and go to your <strong>Dashboard</strong>
              </li>
              <li>
                Find your booking under <strong>"Upcoming Appointments"</strong>
              </li>
              <li>
                Click <strong>"Cancel"</strong> or <strong>"Reschedule"</strong>
              </li>
              <li>Confirm your cancellation or select a new date/time</li>
              <li>You'll receive a confirmation email within minutes</li>
            </ol>
            <p className="text-muted-foreground mt-4">
              Alternatively, you can contact the artist directly through their
              profile page or reach out to our support team for assistance.
            </p>
          </Card>
        </div>
        ...
        <Card className="p-8 bg-muted/30">
          ...
          <p className="text-muted-foreground mb-4">
            ...
            assistance with a booking, please contact us:
          </p>
