...
function ArtistDesignLab() {
  ...
  if (authLoading) {
    return <ArtistDesignLabSkeleton />;
  }
  ...
  const isFreeTier = credits?.tier === "artist_free" || credits?.tier === "artist_paygo";
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div className="flex-1">
            ...
            <p className="text-muted-foreground mt-1">
              Generate tattoo concepts for walk-in clients in seconds.
            </p>
          </div>
              ...
              <CardContent className="flex items-center gap-6 py-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-muted-foreground text-sm">
                    Upgrade to <strong>Pro Studio</strong> ($49/mo) to unlock 50 AI generations per month, or <strong>Elite Icon</strong> ($99/mo) for unlimited access. Mock up designs for walk-ins instantly and close more sales!
                  </p>
                </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <Textarea
                    placeholder="e.g., A client wants a majestic wolf howling at a crescent moon, surrounded by pine trees and geometric patterns..."
                    value={prompt}
                  ...
                  <Card className="py-16">
                    <CardContent className="text-center">
                      ...
                      <p className="text-muted-foreground text-sm max-w-sm mx-auto">
                        {isFreeTier
                          ? "Upgrade to Pro to start generating tattoo design concepts for walk-ins."
...
function ArtistDesignLabSkeleton() {
  return (
    <div className="min-h-screen bg-background">
      <Header />
      <div className="container mx-auto px-4 py-8 max-w-6xl">
...
export default ArtistDesignLab;
