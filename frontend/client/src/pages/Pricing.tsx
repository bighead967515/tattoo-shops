  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1">
        ...
        <section className="py-20 bg-gradient-to-b from-primary/5 to-transparent">
          <div className="container text-center">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              ...
              Clients: post requests and find your perfect artist at no subscription cost.
            </p>
          </div>
        </section>
        ...
        <section className="py-16 container">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold mb-2">Client Access</h2>
            <p className="text-muted-foreground">Post requests, compare bids, and book the perfect artist</p>
          </div>

          <div className="grid gap-6 max-w-3xl mx-auto">
            <Card className="p-7 flex flex-col border-2 border-primary bg-gradient-to-br from-primary/10 to-background">
              <div className="text-center mb-6">
                <h2 className="text-2xl font-bold mb-2">Client Account</h2>
                <div className="text-4xl font-bold mb-1">
                  $0
                  <span className="text-xl text-muted-foreground">/mo</span>
                </div>
              ...
              <div className="space-y-3 text-sm flex-1">
                ...
                <FeatureRow enabled label="Receive and compare artist bids" />
                <FeatureRow enabled label="Book directly with artists" />
              </div>
            </Card>
          </div>
        </section>
