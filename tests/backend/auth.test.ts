...
describe('Authentication & Authorization', () => {
  describe('OAuth Login Flow', () => {
    it('should generate valid OAuth URL with state parameter', () => {
      ...
      const oauthUrl = 'https://example.com/oauth?state=abc123&redirectUri=http://localhost&appId=123'; // Mock
  ...
  describe('Artist Ownership Verification', () => {
    it('should verify artist ownership before update', async () => {
      ...
      const result = { error: 'Forbidden: You can only update your own profile' };
